...
// Data for the table view
 let tableViewData = ["Problem Solving", "BackEnd Development", "FrontEnd Development"]
...
extension BlogView: UITableViewDataSource {
...
extension BlogView: UITableViewDelegate {
